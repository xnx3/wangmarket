# 简介
**网站使用**，延续了帝国CMS、织梦CMS的建站方式，有模版页面、模版变量、栏目绑定模版、内容管理等，用过帝国、织梦的，可快速使用！
**整体结构**， SAAS云建站，可通过后台任意开通多个网站，每个网站使用自己的账号进行独立管理。可私有化部署自己的SAAS云建站。

# 功能

* 在线开通网站，无需任何操作服务器操作
	* 可通过后台（系统中的agency代理后台账户）在线开通网站
...
* 安全
	* 数据、附件等都在你自己服务器或者相关阿里云账户上，数据都在手里！不少老板的心里，数据自己掌握着心里头才是安全的，我们系统在这方面让你安心。
