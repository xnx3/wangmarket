...
* **多语言翻译js库**，是一款全自动翻译组件，引入几行js代码就能使你原本的中文网站（一种语言的网站），具有多种语言切换能力。同时对SEO友好 [开源仓库&使用方式](https://gitee.com/mail_osc/translate)
...
企业版授权的价格是5000元永久。一次授权，永久使用，永久免费升级。

#### 体验活动

**商业授权版本免费使用体验三个月**
联合华为云推出活动，安装到华为云服务器，享有商业授权版本免费体验三个月，满三个月后

* 如果购买授权，你依旧能享受前三个月的各种服务。
* 如果不购买授权，建站系统主要能力及大部分插件你依旧可以正常使用，但你将失去：
  1. 其中的几个收费的功能插件将无法使用
  2. 不再享有售后。我们售后团队将不再免费提供咨询及指导。

我们有专门技术人员全程帮你部署调试好、并会拉专属服务群，使用中有疑问给予帮助咨询，帮您使好它，给您实际业务真的能产生帮助及带来盈利。

##### 参与联系

* 联系电话 15264605315 （微信同号）

##### 参与步骤：

1. 通过 huawei.leimingyun.com 开通华为云账户、并进行实名认证。认证完后不要购买任何东西，不然将失去新用户身份。
2. 结合华为云新用户优惠活动，购买一台1核2G服务器，大概一年一二百（不明白如何选的话我们安排技术帮你操作）
3. 需要你在华为云有已备案域名（如果没有，可以先给你安装，等你进行备案完成后给你配置好）
...
本系统十余项相关知识产权受国家法律保护。
我们允许你完全可以将它来进行商用盈利，但请在 [网站管理后台保留我们的版权标识](https://e.gitee.com/leimingyun/doc/share/78815f06cd4554b7/?sub_id=7975426) 不要删掉。
