...
public class AttachmentUtil {
	...
	public static StorageModeInterface getStorageMode(){
		...
		if(storageMode == null){
			...
			if(AttachmentUtil.mode == null){
				...
				if(mode.equalsIgnoreCase(AttachmentUtil.MODE_ALIYUN_OSS)){
					storageMode = new AliyunOSSMode();
				}else if (mode.equalsIgnoreCase(AttachmentUtil.MODE_LOCAL_FILE)) {
					storageMode = new LocalServerMode();
				}else if (mode.equalsIgnoreCase(AttachmentUtil.MODE_HUAWEIYUN_OBS)) {
	...
	public static boolean isMode(String mode){
		...
		return AttachmentUtil.mode.equals(mode);
	}
