 ...
 */
public class MQBean {
	public final static int TYPE_DOMAIN = 1;		//更新二级域名，系统分配的域名
	public final static int TYPE_BIND_DOMAIN = 2;	//更新自己绑定的顶级域名
	public final static int TYPE_STATE = 3;			//更新网站的状态，比如暂停网站、正常访问等网站状态
	public final static int TYPE_NEW_SITE = 4;		//创建新的网站
