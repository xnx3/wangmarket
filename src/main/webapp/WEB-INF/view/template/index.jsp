...
<style> /* 显示多语种切换 */ .translateSelectLanguage{ display:block; top: 0;padding: 0.35rem 0.6rem!important; padding-top: 0.4rem!important; border-radius: 30px;transform: translateY(-4px);font-size: 12px; width:94px;} </style>