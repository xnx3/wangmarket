...
<div style="padding:10px; font-size:24px;">
	<a href="<%=basePath %>/message/add.do"  style="color:blue;">新建信息</a>｜
	<a href="<%=basePath %>/message/list.do?state=0&box=inbox"  style="color:blue;">收件箱未读消息</a>｜
	<a href="<%=basePath %>/message/list.do?state=1&box=inbox"  style="color:blue;">收件箱已读消息</a>｜
	<a href="<%=basePath %>/message/list.do?state=0&box=outbox"  style="color:blue;">发件箱未读消息</a>｜
	<a href="<%=basePath %>/message/list.do?state=1&box=outbox"  style="color:blue;">发件箱已读消息</a>
</div>
<div>
