...
CREATE TABLE `plugin_bbs_post` (
  ...
  PRIMARY KEY (`id`),
  KEY `classid` (`classid`,`view`,`userid`,`siteid`,`isdelete`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='论坛插件-帖子';
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='论坛的分类，大类';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='论坛帖子的回复（暂未用到，预留）';
