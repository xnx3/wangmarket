/*
 ...
 Source Server         : 192.168.31.11-novel
 Source Server Type    : MySQL
 Source Server Version : 50741
 Source Host           : 192.168.31.11
...
-- ----------------------------
BEGIN;
INSERT INTO `agency` VALUES ('51', '管雷鸣&#40;代理后台agency修改&#41;', '17000000001', '392', '1024', '120', '山东潍坊（您可通过代理后台agency修改此处的信息）', '921153866', '99999999', '2', '0', '1512818402', '2143123200', '1', '0', '0', '0');
COMMIT;
...
CREATE TABLE `news` (
  ...
  `html_name` char(50) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '要生成的html文件的名字，留空时使用文章ID命名',
  ...
  KEY `suoyin_index` (`userid`,`addtime`,`type`,`status`,`cid`,`siteid`,`html_name`)
...
CREATE TABLE `site` (
  ...
  `keywords` char(200) COLLATE utf8_unicode_ci DEFAULT '' COMMENT '搜索的关键词',
  ...
  `remark` char(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '站点备注，代理商给网站的备注，方便代理商记录这个网站干嘛的',
  `generate_html_storage_type` char(20) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '生成html页面的方式，存储方式， obs:obs buckname存储，  ftp:ftp方式存储，  空或者default或者其他则是默认的AttachmentUtil 方式存储',
  PRIMARY KEY (`id`),
...
-- ----------------------------
BEGIN;
INSERT INTO `site` VALUES ('219', '测试演示自定义模版站', '243', '1488446743', '1', '17753600820', '25689732', '1', 'cs', '591', null, '3', '测试演示的自定义模版站', '潍坊软件园', '雷爷', '', '', null, '1', '0', null, '', '0', '2000123200', '1', '0', '1000', '20220318', null, 'default');
COMMIT;
...
CREATE TABLE `site_column` (
  ...
  `edit_use_html_name` tinyint(2) DEFAULT '0' COMMENT '内容管理中，添加内容时，自定义生成 HTML 页面名称的输入。0隐藏，1显示',
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'admin', '', '94940b4491a87f15333ed68cc0cdf833', 'default.png', '总管理', '9', '1512818402', '1647601382', '127.0.0.1', '9738', '17000000002', '0', '0', '0.00', '127.0.0.1', '0', '0.00', null, null, '0'), ('243', 'wangzhan', '', '0c5a0883e40a2a6ad84a42eab27519e6', '70877108e0684e1d9586f327eb5aafb5.png', '客服小红', '1', '1488446743', '1647601286', '218.56.88.231', '6922', '', '0', '392', '0.00', '127.0.0.1', '0', '0.00', null, null, '254'), ('392', 'agency', '', '80c5df10de72fde1b346de758c70d337', 'default.png', '代理', '10', '1512818402', '1647601180', '127.0.0.1', '9738', '17000000001', '0', '1', '0.00', '127.0.0.1', '0', '0.00', null, null, '1');
COMMIT;
