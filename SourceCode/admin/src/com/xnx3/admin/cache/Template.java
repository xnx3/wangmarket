...
public class Template {
	private com.xnx3.admin.entity.Site site;
...
//	private boolean editMode = false;	//是否是编辑模式，默认不是编辑模式，用户端前台查看，正常网站浏览模式
	...
	public Template(com.xnx3.admin.entity.Site site) {
		this.site = site;
...
//		editMode = false;
	...
	public Template(com.xnx3.admin.entity.Site site, boolean editMode) {
		this.site = site;
...
//		this.editMode = editMode;
	...
	public String getIndexTemplateHtml_Only(){
		return FileUtil.read(Global.getProjectPath()+"/WEB-INF/template/"+templateId+"/index.html");
	}
