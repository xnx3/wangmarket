...
@Controller
@RequestMapping("/")
public class LoginController extends com.xnx3.admin.controller.BaseController {
	@Resource
	 ...
	 */
	@RequestMapping(value="sendPhoneRegCodeByAliyun", method = RequestMethod.POST)
	@ResponseBody
...
//		}
	 ...
	 * @param clilent 网站类型
	 */
	@RequestMapping(value="userCreateSite", method = RequestMethod.POST)
	@ResponseBody
