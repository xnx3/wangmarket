...
public class ColumnController extends BaseController {
	...
	public String list(HttpServletRequest request,Model model){
	    ...
	    model.addAttribute("siteid", filter(request.getParameter("siteid")));
	    return "column/list";
	}
	 ...
	 */
	@RequestMapping("/popupListForTemplate")
	 ...
	 * @param id 栏目id
	 */
	@RequestMapping("/popupColumnUpdate")
	 ...
	 */
	@RequestMapping("/popupColumnGaoJiUpdate")
	 ...
	 */
	@RequestMapping("/popupColumnForTemplate")
...
//		sc.setRank(siteColumn.getRank());	排序更改是有单独的方法进行的，不再这里。这里更改不了排序
	...
	public BaseVO saveRank(HttpServletRequest request,
		...
		new com.xnx3.admin.cache.Site().siteColumnRank(site, Sql.filter(rankString));
		return new BaseVO();
	}
