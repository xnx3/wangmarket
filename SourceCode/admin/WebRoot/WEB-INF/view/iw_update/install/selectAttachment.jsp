...
<div class="select">
	...
	<div class="selectItem" onclick="window.location.href='setAttachmentMode.do?mode=<%=AttachmentFile.MODE_LOCAL_FILE %>';">
	...
	<br/>
	<div class="selectItem" onclick="window.location.href='setAttachmentMode.do?mode=<%=AttachmentFile.MODE_ALIYUN_OSS %>';">
