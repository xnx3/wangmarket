		...
		<c:forEach items="${list}" var="site">
			<tr>
				...
				<c:choose>
				    ...
				    <c:otherwise>
				        <td onclick="window.open('http://${site['domain'] }.<%=com.xnx3.admin.G.getFirstAutoAssignDomain() %>'); " style="cursor: pointer; width: 180px;">${site['domain'] }.<%=com.xnx3.admin.G.getFirstAutoAssignDomain() %></td>
				    </c:otherwise>
				</c:choose>
