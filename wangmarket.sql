...
-- ----------------------------
BEGIN;
INSERT INTO `agency` VALUES ('51', '管雷鸣', '17000000001', '392', '1024', '120', '山东潍坊', '921153866', '99999999', '0', '51', '1512818402', '2143123200', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `role` VALUES ('1', '会员', '普通会员'), ('9', '超级管理员', '总后台管理'), ('10', '商用代理', '商代理，用户注册后就送1000M空间，可以开通子代理，允许售卖');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `site` VALUES ('219', '测试演示自定义模版站', '243', '1488446743', '1', '17753600820', '25689732', '1', 'cs', '591', null, '3', '测试演示的自定义模版站', '潍坊软件园', '雷爷', '', '', null, '1', '0', null, 'qiye1', '0', '2143123200', '1');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('1', 'admin', '', '94940b4491a87f15333ed68cc0cdf833', 'default.png', '总管理', '9', '1512818402', '1512818402', '127.0.0.1', '9738', '17000000002', '0', '326', '0.00', '127.0.0.1', '0', '0.00', '0', null, null, null, '0', '1024', '0'), ('243', 'ceshicms', '', '79215458e973d2f8f39998838d148df9', '70877108e0684e1d9586f327eb5aafb5.png', '客服小红', '1', '1488446743', '1515402694', '218.56.88.231', '7466', '', '0', '50', '0.00', '127.0.0.1', '0', '0.00', '0', null, null, '20180108', '0', '1000', '254'), ('392', 'agency', '', '80c5df10de72fde1b346de758c70d337', 'default.png', '代理', '10', '1512818402', '1515402763', '127.0.0.1', '9738', '17000000001', '0', '326', '0.00', '127.0.0.1', '0', '0.00', '0', null, null, null, '0', '1024', '1');
COMMIT;
